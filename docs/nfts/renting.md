---
icon: handshake
description: Pay for a number of days, race with the NFT as if you owned it, and it returns to the platform on its own.
---
...
<figure><img src="../../.gitbook/assets/nfts/app-marketplace-rent-button-desktop.png" alt="A marketplace tier showing a Rent button beside the Buy button"><figcaption><p>A tier without a Rent button is not rentable at all.</p></figcaption></figure>
{% endcolumn %}
...
<figure><img src="../../.gitbook/assets/nfts/app-rented-ribbon-desktop.png" alt="A picker tile carrying a RENTED ribbon in the corner"><figcaption><p>The ribbon is on your own screens only. Other players never see it.</p></figcaption></figure>
{% endcolumn %}

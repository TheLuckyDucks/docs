...
<figure><img src="../.gitbook/assets/brand/docs-hero-race-canvas.png" alt="Five ducks racing across the pond with position markers above them"><figcaption><p>A five player race, mid-run. The animation follows the seed the oracle published on chain.</p></figcaption></figure>

...
* **Join setting (who can join)**. Open by default. Switch to Verified Only, Allowed Players, NFT Holders, or Token Holders to gate the race. See [Race access and gating](access-and-gating.md).

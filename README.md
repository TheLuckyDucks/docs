...
The left sidebar groups topics by what you might want to do:

1. **Getting Started**. The shortest path from connecting a wallet to your first race.
2. **Races**. Creating, joining, and configuring a race.
3. **NFTs**. The four collections, what each one does, where to acquire them.
4. **Competition**. Tournaments, teams, rematches.
5. **Economy**. Fees, payouts, refunds, rent.
